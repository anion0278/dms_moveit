...
replan_intensity = 0
simultaneous_vibration_intensity_factor = 0.8

dist_intensity_max = 255
dist_intensity_min = 110
vibr_min = 70
vibr_max = 255

reaction_dist_m = 0.15  # distance on which HMIs start to react (proportionally)
